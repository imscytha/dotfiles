...
vim.api.nvim_create_autocmd("FileType", {
  group = vim.api.nvim_create_augroup("scytha/big_file", { clear = true }),
...
vim.api.nvim_create_autocmd("FileType", {
  group = vim.api.nvim_create_augroup("scytha/close_with_q", { clear = true }),
  desc = "Close with <q>",
  pattern = {
    "git",
    "help",
...
--     group = vim.api.nvim_create_augroup('scytha/dotfiles_setup', { clear = true }),
...
vim.api.nvim_create_autocmd("BufReadPost", {
  group = vim.api.nvim_create_augroup("scytha/last_location", { clear = true }),
...
local line_numbers_group =
  vim.api.nvim_create_augroup("scytha/toggle_line_numbers", {})
vim.api.nvim_create_autocmd(
  { "BufEnter", "FocusGained", "InsertLeave", "CmdlineLeave", "WinEnter" },
  {
    ...
    callback = function()
      if
        vim.wo.nu and not vim.startswith(vim.api.nvim_get_mode().mode, "i")
      then
...
-- vim.api.nvim_create_autocmd("FileType", {
--   group = vim.api.nvim_create_augroup("scytha/treesitter_folding", { clear = true }),
...
--     group = vim.api.nvim_create_augroup('scytha/yank_highlight', { clear = true }),
