...
# Considering MacOS utilities are based on BSD utilities[1] they don't support
# colors natively[2] like GNU coreutils (with `--color` flag)[3].
# Instead of installing extra dependency for adding colors on top of diff,
# utilize git's diff engine that supports colors[4]
#
# ref:
