...
> **Warning**
> *This script should only be used if you plan keeping the dotfiles repository since the symbolic link points from the current directory.
Also if you change the path of this repo you need to run `symlink.sh` again to update the old path of the link so that it points to the new correct path.*
